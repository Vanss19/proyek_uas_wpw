...
<head>
  ...
  <title>Grades &mdash; E-Learn</title>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="nav-link" href="index.php">Grades</a></li>
            ...
            <form action="edit.php" method="post">
              <div class="modal-body">
                ...
                <div class="form-group">
                  <label>Nama Grade</label>
                  <div class="input-group">
                    <input type="text" class="form-control" placeholder="..." name="grade" id="grade" value="<?= $dt['grade'] ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label>Major</label>
                  <select class="form-control" name="major_id" id="major_id">
                    <option value="<?= $dt['major_id'] ?>"><?= $dt['major'] ?></option>
                    <?php foreach($majors as $major): ?>
                    <option value="<?= $major['id'] ?>"><?= $major['major'] ?></option>
                    <?php endforeach; ?>
                  </select>
