...
<head>
  ...
  <title>Subjects &mdash; E-Learn</title>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link active" href="../majors/index.php">Majors</a></li>
                <li><a class="nav-link" href="../grades/index.php">Grades</a></li>
                <li><a class="nav-link" href="index.php">Subjects</a></li>
              </ul>
            </li>
            <li class="nav-item">
                    ...
                    <tbody>
                      <?php foreach($data as $dt): ?>
                        <tr>
                          ...
                          <td><?= $dt['subject'] ?></td>
                          <td><?= $dt['grade'].' - '.$dt['major'] ?></td>
                          <td>
                            <button type="button" class="btn btn-warning editbtn" id="editBtn<?= $dt['id'] ?>" data-toggle="modal" data-target="#modalEdit<?= $dt['id'] ?>"><i class="fas fa-pen-to-square"></i></button>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="staticBackdropLabel">Add Grade</h5>
            ...
            <form action="edit.php" method="post">
              <div class="modal-body">
                ...
                <div class="form-group">
                  <label>Nama Subject</label>
                  <div class="input-group">
                    <input type="text" class="form-control" placeholder="..." name="subject" id="subject" value="<?= $dt['subject'] ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label>Grade</label>
                  <select class="form-control" name="grade_id" id="grade_id">
                    <option value="<?= $dt['grade_id'] ?>"><?= $dt['grade'] ?> - <?= $dt['major'] ?></option>
                    <?php foreach($grades as $grade): ?>
                    <option value="<?= $grade['id'] ?>"><?= $grade['grade'] ?> - <?= $grade['major'] ?></option>
                    <?php endforeach; ?>
                  </select>
